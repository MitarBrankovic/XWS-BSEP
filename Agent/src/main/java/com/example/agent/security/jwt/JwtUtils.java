package com.example.agent.security.jwt;
...
public class JwtUtils {
    ...
    public String generateToken(AgentUser AgentUser) {
        Map<String, Object> claims = new HashMap<>();
        return createToken(claims, AgentUser);
    }
    ...
    private String createToken(Map<String, Object> claims, AgentUser user) {
