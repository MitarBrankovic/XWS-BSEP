...
var file_user_service_proto_rawDesc = []byte{
	...
	0x52, 0x0b, 0x61, 0x63, 0x63, 0x65, 0x73, 0x73, 0x54, 0x6f, 0x6b, 0x65, 0x6e, 0x22, 0xdc, 0x01,
	...
	0x6c, 0x61, 0x73, 0x74, 0x4e, 0x61, 0x6d, 0x65, 0x12, 0x3c, 0x0a, 0x0b, 0x64, 0x61, 0x74, 0x65,
	...
	0x07, 0x20, 0x01, 0x28, 0x09, 0x52, 0x05, 0x65, 0x6d, 0x61, 0x69, 0x6c, 0x32, 0xef, 0x02, 0x0a,
	...
	0x93, 0x02, 0x0b, 0x22, 0x06, 0x2f, 0x6c, 0x6f, 0x67, 0x69, 0x6e, 0x3a, 0x01, 0x2a, 0x42, 0x16,
	0x5a, 0x14, 0x64, 0x69, 0x73, 0x6c, 0x69, 0x6e, 0x6b, 0x74, 0x2f, 0x63, 0x6f, 0x6d, 0x6d, 0x6f,
...
var file_user_service_proto_depIdxs = []int32{
	...
	10, // 2: user.CreateRequest.user:type_name -> user.User
	10, // 3: user.CreateResponse.user:type_name -> user.User
	10, // 4: user.UpdateRequest.user:type_name -> user.User
	10, // 5: user.UpdateResponse.user:type_name -> user.User
	11, // 6: user.User.dateOfBirth:type_name -> google.protobuf.Timestamp
	0,  // 7: user.UserService.Get:input_type -> user.GetRequest
	2,  // 8: user.UserService.GetAll:input_type -> user.GetAllRequest
	4,  // 9: user.UserService.Create:input_type -> user.CreateRequest
	6,  // 10: user.UserService.Update:input_type -> user.UpdateRequest
	8,  // 11: user.UserService.Login:input_type -> user.LoginRequest
	1,  // 12: user.UserService.Get:output_type -> user.GetResponse
	3,  // 13: user.UserService.GetAll:output_type -> user.GetAllResponse
	5,  // 14: user.UserService.Create:output_type -> user.CreateResponse
	7,  // 15: user.UserService.Update:output_type -> user.UpdateResponse
