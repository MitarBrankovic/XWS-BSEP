...
var file_user_service_proto_rawDesc = []byte{
	...
	0x65, 0x12, 0x1e, 0x0a, 0x04, 0x75, 0x73, 0x65, 0x72, 0x18, 0x01, 0x20, 0x01, 0x28, 0x0b, 0x32,
	0x0a, 0x2e, 0x75, 0x73, 0x65, 0x72, 0x2e, 0x55, 0x73, 0x65, 0x72, 0x52, 0x04, 0x75, 0x73, 0x65,
	0x72, 0x22, 0x3c, 0x0a, 0x1e, 0x50, 0x61, 0x73, 0x73, 0x77, 0x6f, 0x72, 0x64, 0x6c, 0x65, 0x73,
	...
	0x09, 0x52, 0x05, 0x65, 0x6d, 0x61, 0x69, 0x6c, 0x32, 0x8b, 0x06, 0x0a, 0x0b, 0x55, 0x73, 0x65,
...
var file_user_service_proto_goTypes = []interface{}{
	...
	(*PasswordlessLoginDemandRequest)(nil),  // 14: user.PasswordlessLoginDemandRequest
	(*PasswordlessLoginDemandResponse)(nil), // 15: user.PasswordlessLoginDemandResponse
	(*PasswordlesLoginRequest)(nil),         // 16: user.PasswordlesLoginRequest
...
var file_user_service_proto_depIdxs = []int32{
	...
	17, // 2: user.CreateRequest.user:type_name -> user.User
	17, // 3: user.CreateResponse.user:type_name -> user.User
	17, // 4: user.UpdateRequest.user:type_name -> user.User
	17, // 5: user.UpdateResponse.user:type_name -> user.User
	17, // 6: user.RegisterRequest.user:type_name -> user.User
	17, // 7: user.RegisterResponse.user:type_name -> user.User
	17, // 8: user.ActivateResponse.user:type_name -> user.User
	18, // 9: user.User.dateOfBirth:type_name -> google.protobuf.Timestamp
	...
	14, // 17: user.UserService.PasswordlessLoginDemand:input_type -> user.PasswordlessLoginDemandRequest
	16, // 18: user.UserService.PasswordlessLogin:input_type -> user.PasswordlesLoginRequest
	1,  // 19: user.UserService.Get:output_type -> user.GetResponse
	3,  // 20: user.UserService.GetAll:output_type -> user.GetAllResponse
	5,  // 21: user.UserService.Create:output_type -> user.CreateResponse
	7,  // 22: user.UserService.Update:output_type -> user.UpdateResponse
	9,  // 23: user.UserService.Login:output_type -> user.LoginResponse
	11, // 24: user.UserService.Register:output_type -> user.RegisterResponse
	13, // 25: user.UserService.ActivateAccount:output_type -> user.ActivateResponse
	15, // 26: user.UserService.PasswordlessLoginDemand:output_type -> user.PasswordlessLoginDemandResponse
	9,  // 27: user.UserService.PasswordlessLogin:output_type -> user.LoginResponse
