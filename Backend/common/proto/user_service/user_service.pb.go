...
var file_user_service_proto_rawDesc = []byte{
	...
	0x75, 0x73, 0x65, 0x72, 0x22, 0xdc, 0x01, 0x0a, 0x04, 0x55, 0x73, 0x65, 0x72, 0x12, 0x0e, 0x0a,
	...
	0x61, 0x69, 0x6c, 0x32, 0xc3, 0x03, 0x0a, 0x0b, 0x55, 0x73, 0x65, 0x72, 0x53, 0x65, 0x72, 0x76,
	...
	0x12, 0x05, 0x2f, 0x75, 0x73, 0x65, 0x72, 0x12, 0x48, 0x0a, 0x06, 0x43, 0x72, 0x65, 0x61, 0x74,
	...
	0x69, 0x6e, 0x3a, 0x01, 0x2a, 0x12, 0x52, 0x0a, 0x08, 0x52, 0x65, 0x67, 0x69, 0x73, 0x74, 0x65,
	...
	0x74, 0x65, 0x72, 0x3a, 0x04, 0x75, 0x73, 0x65, 0x72, 0x42, 0x16, 0x5a, 0x14, 0x64, 0x69, 0x73,
...
var file_user_service_proto_depIdxs = []int32{
	12, // 0: user.GetResponse.user:type_name -> user.User
	12, // 1: user.GetAllResponse.users:type_name -> user.User
	12, // 2: user.CreateRequest.user:type_name -> user.User
	12, // 3: user.CreateResponse.user:type_name -> user.User
	12, // 4: user.UpdateRequest.user:type_name -> user.User
	12, // 5: user.UpdateResponse.user:type_name -> user.User
	12, // 6: user.RegisterRequest.user:type_name -> user.User
	12, // 7: user.RegisterResponse.user:type_name -> user.User
	13, // 8: user.User.dateOfBirth:type_name -> google.protobuf.Timestamp
	0,  // 9: user.UserService.Get:input_type -> user.GetRequest
	2,  // 10: user.UserService.GetAll:input_type -> user.GetAllRequest
	4,  // 11: user.UserService.Create:input_type -> user.CreateRequest
	6,  // 12: user.UserService.Update:input_type -> user.UpdateRequest
	8,  // 13: user.UserService.Login:input_type -> user.LoginRequest
	10, // 14: user.UserService.Register:input_type -> user.RegisterRequest
	1,  // 15: user.UserService.Get:output_type -> user.GetResponse
	3,  // 16: user.UserService.GetAll:output_type -> user.GetAllResponse
	5,  // 17: user.UserService.Create:output_type -> user.CreateResponse
	7,  // 18: user.UserService.Update:output_type -> user.UpdateResponse
	9,  // 19: user.UserService.Login:output_type -> user.LoginResponse
	11, // 20: user.UserService.Register:output_type -> user.RegisterResponse
