...
var file_user_service_proto_rawDesc = []byte{
	...
	0x72, 0x22, 0xc0, 0x01, 0x0a, 0x04, 0x55, 0x73, 0x65, 0x72, 0x12, 0x0e, 0x0a, 0x02, 0x69, 0x64,
	...
	0x70, 0x52, 0x0b, 0x64, 0x61, 0x74, 0x65, 0x4f, 0x66, 0x42, 0x69, 0x72, 0x74, 0x68, 0x12, 0x14,
	0x0a, 0x05, 0x65, 0x6d, 0x61, 0x69, 0x6c, 0x18, 0x07, 0x20, 0x01, 0x28, 0x09, 0x52, 0x05, 0x65,
	0x6d, 0x61, 0x69, 0x6c, 0x32, 0xaa, 0x02, 0x0a, 0x0b, 0x55, 0x73, 0x65, 0x72, 0x53, 0x65, 0x72,
	...
	0x07, 0x12, 0x05, 0x2f, 0x75, 0x73, 0x65, 0x72, 0x12, 0x48, 0x0a, 0x06, 0x43, 0x72, 0x65, 0x61,
...
var file_user_service_proto_depIdxs = []int32{
	...
	8,  // 2: user.CreateRequest.user:type_name -> user.User
	8,  // 3: user.CreateResponse.user:type_name -> user.User
	8,  // 4: user.UpdateRequest.user:type_name -> user.User
	8,  // 5: user.UpdateResponse.user:type_name -> user.User
	9,  // 6: user.User.dateOfBirth:type_name -> google.protobuf.Timestamp
	...
	5,  // 13: user.UserService.Create:output_type -> user.CreateResponse
	7,  // 14: user.UserService.Update:output_type -> user.UpdateResponse
