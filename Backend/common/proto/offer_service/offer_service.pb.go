...
func (x *CreateMonoRequest) Reset() {
	*x = CreateMonoRequest{}
	if protoimpl.UnsafeEnabled {
...
func (x *CreateMonoRequest) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*CreateMonoRequest) ProtoMessage() {}

func (x *CreateMonoRequest) ProtoReflect() protoreflect.Message {
	mi := &file_offer_service_proto_msgTypes[8]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use CreateMonoRequest.ProtoReflect.Descriptor instead.
func (*CreateMonoRequest) Descriptor() ([]byte, []int) {
	return file_offer_service_proto_rawDescGZIP(), []int{8}
}

func (x *CreateMonoRequest) GetToken() string {
	if x != nil {
		return x.Token
	}
	return ""
...
func (x *CreateMonoRequest) GetOffer() *Offer {
	if x != nil {
		return x.Offer
	}
	return nil
...
type CreateMonoResponse struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields
...
func (x *CreateMonoResponse) Reset() {
	*x = CreateMonoResponse{}
	if protoimpl.UnsafeEnabled {
		mi := &file_offer_service_proto_msgTypes[9]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}

func (x *CreateMonoResponse) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*CreateMonoResponse) ProtoMessage() {}

func (x *CreateMonoResponse) ProtoReflect() protoreflect.Message {
	mi := &file_offer_service_proto_msgTypes[9]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use CreateMonoResponse.ProtoReflect.Descriptor instead.
func (*CreateMonoResponse) Descriptor() ([]byte, []int) {
	return file_offer_service_proto_rawDescGZIP(), []int{9}
}

func (x *CreateMonoResponse) GetOffer() *Offer {
	if x != nil {
		return x.Offer
	}
	return nil
...
func (x *Offer) Reset() {
	*x = Offer{}
	if protoimpl.UnsafeEnabled {
		mi := &file_offer_service_proto_msgTypes[10]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*Offer) Descriptor() ([]byte, []int) {
	return file_offer_service_proto_rawDescGZIP(), []int{10}
}
...
var file_offer_service_proto_rawDesc = []byte{
	...
	,
	...
	,
...
var file_offer_service_proto_msgTypes = make([]protoimpl.MessageInfo, 11)
var file_offer_service_proto_goTypes = []interface{}{
	...
	(*CreateMonoRequest)(nil),     // 8: offer.CreateMonoRequest
	(*CreateMonoResponse)(nil),    // 9: offer.CreateMonoResponse
	(*Offer)(nil),                 // 10: offer.Offer
	(*timestamppb.Timestamp)(nil), // 11: google.protobuf.Timestamp
}
var file_offer_service_proto_depIdxs = []int32{
	10, // 0: offer.GetResponse.offer:type_name -> offer.Offer
	10, // 1: offer.GetAllResponse.offers:type_name -> offer.Offer
	10, // 2: offer.CreateRequest.offer:type_name -> offer.Offer
	10, // 3: offer.CreateResponse.offer:type_name -> offer.Offer
	10, // 4: offer.UpdateRequest.offer:type_name -> offer.Offer
	10, // 5: offer.UpdateResponse.offer:type_name -> offer.Offer
	10, // 6: offer.CreateMonoRequest.offer:type_name -> offer.Offer
	10, // 7: offer.CreateMonoResponse.offer:type_name -> offer.Offer
	11, // 8: offer.Offer.createdAt:type_name -> google.protobuf.Timestamp
	0,  // 9: offer.OfferService.Get:input_type -> offer.GetRequest
	2,  // 10: offer.OfferService.GetAll:input_type -> offer.GetAllRequest
	4,  // 11: offer.OfferService.Create:input_type -> offer.CreateRequest
	6,  // 12: offer.OfferService.Update:input_type -> offer.UpdateRequest
	8,  // 13: offer.OfferService.CreateMono:input_type -> offer.CreateMonoRequest
	1,  // 14: offer.OfferService.Get:output_type -> offer.GetResponse
	3,  // 15: offer.OfferService.GetAll:output_type -> offer.GetAllResponse
	5,  // 16: offer.OfferService.Create:output_type -> offer.CreateResponse
	7,  // 17: offer.OfferService.Update:output_type -> offer.UpdateResponse
	9,  // 18: offer.OfferService.CreateMono:output_type -> offer.CreateMonoResponse
...
func file_offer_service_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_offer_service_proto_msgTypes[8].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*CreateMonoRequest); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_offer_service_proto_msgTypes[9].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*CreateMonoResponse); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_offer_service_proto_msgTypes[10].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*Offer); i {
			case 0:
				return &v.state
			case 1:
